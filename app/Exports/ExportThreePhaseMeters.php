...
class ExportThreePhaseMeters implements FromQuery, WithChunkReading, WithHeadings, WithMapping
{
    ...
    public function query()
    {
        return Meter::query()
            ->notInternal()
            ->whereHas('type', fn ($query) => $query->where('name', 'Three Phase Electricity'))
